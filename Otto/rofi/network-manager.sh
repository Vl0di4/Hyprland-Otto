...
manage_wifi() {
    ...
    local chosen_network=$(echo -e "$formatted_list" | rofi -theme ~/.config/rofi/launchers/type-7/style-2.rasi -dmenu -i -selected-row 1 -p " Wi-Fi SSID: ")
    local ssid_index=-1
    ...
    if [ -z "$chosen_network" ]; then
        ...
        action=$(echo -e "$action\n Forget" | rofi -theme ~/.config/rofi/launchers/type-7/style-2.rasi -dmenu -p "Action: ")
        case $action in
            "󰸋 Connect")
...
manage_ethernet() {
    ...
    local chosen_device=$(echo -e "$eth_list" | rofi -theme ~/.config/rofi/launchers/type-7/style-2.rasi -dmenu -i -p " Select Ethernet device: ")
...
main_menu() {
    ...
    ##==> Выводим Rofi меню
    #######################################################
    local chosen_option=$(echo -e "$wifi_toggle$manage_wifi_btn\n󱓥 Manage Ethernet" | rofi -theme ~/.config/rofi/launchers/type-7/style-2.rasi -dmenu -p "  Network Management: ")
